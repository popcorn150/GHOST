...
const AccountSetup = () => {
    ...
    const validatePassword = (pwd) => {
        ...
        } else if (!/[A-Za-z]/.test(pwd) || !/\d/.test(pwd) || !/[!@#$%^&*]/.test(pwd)) {
        ...
        <div className="relative flex items-center justify-center bg-[#010409] w-full h-screen overflow-hidden">
            ...
            <div className="absolute flex flex-col items-center gap-8 px-6 md:flex-row md:gap-30">
                ...
                <div className="flex flex-col items-center bg-[#010409] p-7 md:p-14 rounded-xl w-full max-w-md">
                    <h1 className="text-white text-xl lg:text-2xl font-semibold mb-4">Finish Account Set-Up</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            />
                            {!isUsernameAvailable && (
                                <p className="text-red-500 text-sm mt-1">Username taken. Try: {suggestedUsernames.join(", ")}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p className={`text-sm mt-1 ${passwordStrength === "Strong" ? "text-green-400" : "text-yellow-400"}`}>{passwordStrength}</p>
                        </div>
                        ...
                        <div className="flex items-center text-white">
                            ...
                            <label className="text-sm">
                                I am 13 years or older and agree to the <a href="#" className="text-[#4426B9] font-semibold">Ghost Subscriber Agreement</a> and <a href="#" className="text-[#4426B9] font-semibold">Privacy Policy</a>.
                            </label>
                        </div>
