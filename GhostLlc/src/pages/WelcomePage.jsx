        ...
        <div className="flex flex-col items-center bg-[#010409] p-7 md:p-14 rounded-xl w-full max-w-sm">
          ...
          <div className="grid gap-5 mt-5 w-full">
            <button
              ...
              className="flex items-center justify-center w-full p-3 bg-white hover:bg-gray-300 rounded-3xl shadow-md transition duration-200"
            >
          ...
          <p className="text-gray-400 text-center text-xs my-3">
            Already have an account?
          </p>

          <Link to="/login">
            <button className="w-full mt-5 bg-none border-2 border-gray-500 text-white text-xs font-medium p-2 rounded-md hover:bg-gray-700 transition">
